...
import AccordionComp2 from '@/components/services/SecondService';
    ...
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg shadow-lg relative max-w-4xl mx-4 max-h-[80vh] overflow-auto p-6 pt-12">
        ...
        <div className="relative bg-gray mt-2 h-full overflow-auto">
          <h2 className="text-base text-center font-bold mb-2 tracking-wide">Instrument Rating Requirements</h2>
          <div style={styles.container}>
            <h1 style={styles.title} className='font-semibold text-lg text-center tracking-normal'>FAA Regulations - § 61.65 Instrument Rating Requirements</h1>
